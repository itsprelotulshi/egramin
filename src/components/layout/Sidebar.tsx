      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-3 px-2 py-3 mb-4 rounded-xl bg-slate-800/60 border border-slate-700/50">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-tr from-indigo-600 to-indigo-400 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20 shrink-0">
        ...
        <div className="mt-4 pt-3 border-t border-slate-800">
          ...
          >
            <div className="flex items-center gap-3">
              <Globe className="w-4 h-4 text-indigo-400 group-hover:rotate-12 transition-transform shrink-0" />
